...
Route::get('/demo/table/api/get', [DemoApiController::class, 'tableUsers'])->name('demo.table.api.get');
Route::patch('/demo/table/api/update', [DemoApiController::class, 'tableUserUpdate'])->name('demo.table.api.update');
Route::post('/demo/table/api/create', [DemoApiController::class, 'tableUserCreate'])->name('demo.table.api.create');
