...
@section('content')
    ...
    <section class="mt-14 border-t border-base-300 pt-8" aria-labelledby="integration-heading"><h2 id="integration-heading" class="text-2xl font-semibold">Package integration</h2><p class="mt-3 max-w-3xl leading-7 text-base-content/75">This demo declares Laravel Daisy Kit <code>^5.0</code> from its Git VCS repository, with its committed lock resolving <code>v5.0.0</code>. Every example below mounts the published component and imports its corresponding ESM and CSS entry through the official <code>@daisy-kit</code> Vite alias.</p></section>
@endsection
