...
@section('content')
    ...
    <section class="mt-14 border-t border-base-300 pt-8" aria-labelledby="integration-heading"><h2 id="integration-heading" class="text-2xl font-semibold">Corrective v5 integration</h2><p class="mt-3 max-w-3xl leading-7 text-base-content/75">This development demo locks Laravel Daisy Kit <code>v5.1.0-alpha.1</code> from Git VCS at <code>d906021a82d3b86059551ba8f6042c7823df3dfd</code>. Owner validation of the integrated browser experience remains pending. Every example uses only the published component and its corresponding ESM and CSS entry through the official <code>@daisy-kit</code> Vite alias.</p></section>
@endsection
