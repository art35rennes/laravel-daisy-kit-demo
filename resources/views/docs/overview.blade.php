...
@section('content')
    ...
    <section class="mt-14 border-t border-base-300 pt-8" aria-labelledby="integration-heading"><h2 id="integration-heading" class="text-2xl font-semibold">Package integration checkpoint</h2><p class="mt-3 max-w-3xl leading-7 text-base-content/75">The v5 package prerelease has not been published yet. The examples in this branch document the fixed public contract and use deterministic host fixtures; actual component mounts will be enabled only after Composer resolves the published prerelease.</p></section>
@endsection
