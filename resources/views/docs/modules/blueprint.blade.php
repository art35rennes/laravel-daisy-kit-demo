...
@section('content')
    <article class="max-w-5xl"><p class="text-sm font-medium uppercase tracking-widest text-base-content/70">Module</p><h1 class="mt-3 text-4xl font-bold tracking-tight">Blueprint</h1><p class="mt-5 max-w-3xl text-lg leading-8 text-base-content/75">The graph canvas stays presentational; package-owned semantic controls provide authoring, inspection and keyboard interaction.</p>
