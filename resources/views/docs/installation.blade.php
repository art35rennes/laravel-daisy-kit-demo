    ...
    $composer = <<<'JSON'
{
  ...
  "require": {
    "art35rennes/laravel-daisy-kit": "v5.1.0-alpha.1"
  }
}
JSON;
    $vite = <<<'JS'
...
@section('content')
    <article class="max-w-3xl">
        ...
        <p class="mt-5 leading-7 text-base-content/75">Laravel Daisy Kit is installed from GitHub as a Composer VCS package. This demo pins the immutable <code>v5.1.0-alpha.1</code> prerelease at <code>d906021a82d3b86059551ba8f6042c7823df3dfd</code>; owner browser validation is still pending. It is not published on Packagist or npm.</p>
