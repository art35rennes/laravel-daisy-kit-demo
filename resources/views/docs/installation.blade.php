    ...
    $composer = <<<'JSON'
{
  ...
  "require": {
    "art35rennes/laravel-daisy-kit": "dev-dev"
  }
}
JSON;
    $vite = <<<'JS'
...
import { mountAll } from '@daisy-kit/copyable.js';
...
@section('content')
    <article class="max-w-3xl">
        ...
        <section class="mt-10" aria-labelledby="assets-heading"><h2 id="assets-heading" class="text-2xl font-semibold">3. Import module assets</h2><pre class="code-sample mt-4 overflow-x-auto" tabindex="0" aria-label="Module asset imports"><code>{{ $assets }}</code></pre><p class="mt-3 leading-7 text-base-content/75">Import only the CSS and ESM stem used on the page. The available stems are <code>table</code>, <code>tree</code>, <code>blueprint</code>, <code>file-preview</code>, <code>map</code>, <code>copyable</code>, <code>combobox</code>, <code>signature</code>, <code>truncate</code>, <code>scrollspy</code>, <code>transfer-list</code>.</p></section>
        <section class="mt-10" aria-labelledby="host-heading"><h2 id="host-heading" class="text-2xl font-semibold">4. Keep standard UI in the host</h2><p class="mt-3 leading-7 text-base-content/75">Install Tailwind CSS and DaisyUI ^5.7.22 in the Laravel application. Pages using Signature or Transfer List must allow style-src-attr 'unsafe-inline'; the other nine modules support style-src-attr 'none'. Use their native classes for standard buttons, cards, fields, modals, and navigation.</p><a class="btn btn-outline btn-sm mt-4" href="https://daisyui.com/docs/" target="_blank" rel="noopener noreferrer">DaisyUI documentation <span aria-hidden="true">↗</span></a></section>
