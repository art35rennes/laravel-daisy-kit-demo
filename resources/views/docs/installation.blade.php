    ...
    $composer = <<<'JSON'
{
  ...
  "require": {
    "art35rennes/laravel-daisy-kit": "v5.1.0-alpha.2"
  }
}
JSON;
    $vite = <<<'JS'
...
@section('content')
    <article class="max-w-3xl">
        ...
        <p class="mt-5 leading-7 text-base-content/75">Laravel Daisy Kit is installed from GitHub as a Composer VCS package. This demo pins the immutable <code>v5.1.0-alpha.2</code> prerelease at <code>a674ebd8c124c8c7891b8f2a6c46fbe23c4ddd59</code>; owner browser validation is still pending. It is not published on Packagist or npm.</p>
        <section class="mt-10" aria-labelledby="composer-heading"><h2 id="composer-heading" class="text-2xl font-semibold">1. Require the verified package from VCS</h2><pre class="code-sample mt-4 overflow-x-auto" tabindex="0" aria-label="Composer VCS package configuration"><code>{{ $composer }}</code></pre><p class="mt-3 leading-7 text-base-content/75">Keep this exact prerelease while owner validation is pending. Do not use this development page as compatibility guidance for v5.0.0 or a historical alpha.</p></section>
