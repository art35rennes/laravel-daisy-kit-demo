    ...
    $composer = <<<'JSON'
{
  ...
  "require": {
    "art35rennes/laravel-daisy-kit": "v5.0.0-alpha.2"
  }
}
JSON;
    $vite = <<<'JS'
...
@section('content')
    <article class="max-w-3xl">
        ...
        <p class="mt-5 leading-7 text-base-content/75">Laravel Daisy Kit is installed from GitHub as a Composer VCS package. This demo locks the immutable <code>v5.0.0-alpha.2</code> prerelease; it is not published on Packagist or npm.</p>
