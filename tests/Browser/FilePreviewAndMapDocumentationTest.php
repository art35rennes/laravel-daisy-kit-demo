...
it('exercises typed layers, drawing and the public map facade', function (): void {
    ...
    $page->resize(390, 844)
        ...
        ->assertNoSmoke()
        ->click('#osm-and-business-layers [data-daisy-kit-map-menu] summary')
        ...
        ->assertScript("document.querySelector('#osm-and-business-layers [data-daisy-kit-map-layer=districts]').checked", true)
        ->assertNoSmoke()
        ->click('#drawing-and-export [data-daisy-kit-map-menu] summary')
        ...
        ->click('#facade-and-persistence [data-daisy-kit-map-menu] summary')
