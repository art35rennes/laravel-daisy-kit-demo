...
it('renders the blueprint template preview with layout assets', function () {
    ...
    $template->assertSee('name="demo_blueprint_workflow"', false);
    $template->assertSee('name="demo_blueprint_integration"', false);
    $template->assertSee('data-mode="workflow"', false);
